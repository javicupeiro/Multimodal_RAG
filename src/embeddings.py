...
class EmbeddingsGenerator:
    ...
    def build_prompt(self, user_query, docs):
        ...
        logger.info(f"Context Text for Prompt (Originals - Snippet): {context_text[:500]}...") 
        ...
        prompt_message = [
            {
                "role": "system",
                "content": "Responde a la pregunta en español basándote únicamente en el contexto proporcionado (texto e imágenes)." 
            },
